...
public class CoordenadaLocation implements Serializable {
    ...
    public CoordenadaLocation() {

    }

    public CoordenadaLocation(String imei, Double latitud, Double longitud, String fec_reg, String nivel_bateria, String velocidad, String datos_moviles, String estado_gps) {
        this.imei = imei;
